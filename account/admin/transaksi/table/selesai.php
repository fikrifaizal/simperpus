...
$query = "SELECT transaksi.id_peminjaman, anggota.nama as anggota, buku.judul, buku.isbn,
          ...
          WHERE transaksi.selesai LIKE 1";
                          ...
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              ...
                              <div class="row">
                                ...
                                <p class="col-sm-8"><?=$data['anggota']?> (<?=$data['jabatan']?>)</p>
                              </div>
                              <div class="row">
                                <label class="col-sm-4">Buku</label>
                                <p class="col-sm-8"><?=$data['judul']?> (ISBN: <?=$data['isbn']?>)</p>
                              </div>
                              <div class="row">
                                <label class="col-sm-4">Tanggal Pinjam</label>
                                <p class="col-sm-8"><?=$data['tanggal_pinjam']?></p>
                              </div>
                              <div class="row">
                                <label class="col-sm-4">Tanggal Kembali</label>
                                <p class="col-sm-8"><?=$data['tanggal_kembali']?></p>
                              </div>
                              <div class="row">
