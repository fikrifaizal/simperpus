...
if(isset($_POST['ubah'])){
  if($_POST['nomor'] == $id){
    if(md5($_POST['passwd']) == md5($_POST['passwdulang'])){
      ...
      $update = "UPDATE `petugas` set `password`='$passwd' WHERE `nomor_petugas` LIKE '$id'";
          ...
          <div class="card-body mt-2 mx-1">
            ...
            <form method="post" enctype="multipart/form-data">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <input type="text" name="nomor" class="form-control" id="nip" required>
