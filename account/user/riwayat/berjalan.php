...
$query = "SELECT transaksi.id_peminjaman, transaksi.nomor_klasifikasi,
          ...
          WHERE transaksi.selesai LIKE 0 AND transaksi.nomor_anggota LIKE $id_user";
                          ...
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              ...
                              <div class="row">
                                ...
                                <p class="col-sm-7"><?=$data['nomor_klasifikasi']?> (ISBN: <?=$data['isbn']?>)</p>
                              </div>
                              <div class="row">
                                <label class="col-sm-5">Buku</label>
                                <p class="col-sm-7"><?=$data['judul']?></p>
                              </div>
                              <div class="row">
