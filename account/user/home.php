...
$count_peminjaman = "SELECT COUNT(id_peminjaman) as peminjaman
                      FROM `transaksi` WHERE `selesai` LIKE 1 AND `nomor_anggota` LIKE '$id'";
$query_peminjaman = mysqli_query($conn, $count_peminjaman);
$data_peminjaman = mysqli_fetch_array($query_peminjaman, MYSQLI_ASSOC);

// melewati batas pngembalian
$count_pengembalian = "SELECT COUNT(id_peminjaman) as pengembalian
                        FROM `transaksi` WHERE `selesai` LIKE 0 AND `nomor_anggota` LIKE '$id' AND `tanggal_kembali` < CURDATE()";
        ...
        <div class="row">
          ...
          <div class="col-md-3 mb-3">
            <div class="card bg-danger">
              ...
              <div class="card-footer btn text-white">
                <a href="rak/rak.php" class="text-white" style="text-decoration:none">
                  Lihat Detail
                </a>
                <i class="bi bi-arrow-right-circle"></i>
              </div>
          ...
          <div class="col-md-3 mb-3">
            <div class="card bg-success">
              ...
              <div class="card-footer btn text-white">
                <a href="riwayat/selesai.php" class="text-white" style="text-decoration:none">
                  Lihat Detail
                </a>
                <i class="bi bi-arrow-right-circle"></i>
              </div>
          ...
          <div class="col-md-3 mb-3">
            <div class="card bg-secondary">
              <div class="card-body mt-2 mx-1 text-white">
                <h8 class="">Melewati Batas Pengembalian</h8>
              ...
              <div class="card-footer btn text-white">
                <a href="riwayat/berjalan.php" class="text-white" style="text-decoration:none">
                  Lihat Detail
                </a>
                <i class="bi bi-arrow-right-circle"></i>
              </div>
        ...
        <div class="row">
          <div class="col-md-6 mb-3">
            <div class="card h-100">
              <div class="card-header">
                ...
                Peminjaman Anda bulan Januari-Juni <?=$yearmonth?>
              </div>
              <div class="card-body">
          ...
          <div class="col-md-6 mb-3">
            <div class="card h-100">
              <div class="card-header">
                <span class="me-2"><i class="bi bi-bar-chart-fill"></i></span>
                Peminjaman Anda bulan Juli-Desember <?=$yearmonth?>
              </div>
              <div class="card-body">
            ...
            datasets: [
              {
                ...
                data: [
                  <?php 
                    ...
                    $count_chart = "SELECT id_peminjaman FROM `transaksi` WHERE `tanggal_pinjam` LIKE '%$set_date%' AND `nomor_anggota` LIKE '$id'";
